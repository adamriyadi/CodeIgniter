    ...
    <div class="section">
      ...
      <div class="container">
		...
		<div class="col-lg-12">
		  <h1 class="page-header">"The quick brown fox <small>jumps over the lazy dog"</small></h1>
